...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    // 1. Save raw submission - only include valid database columns
    const submissionData = {
      ...
      smart_lock_brand: formData.smart_lock_brand,
      smart_lock_code: formData.smart_lock_code,
      lockbox_code: formData.lockbox_code,
      backup_key_location: formData.backup_key_location,
      maids_closet_code: formData.maids_closet_code,
      trash_pickup_day: formData.trash_pickup_day,
      trash_bin_location: formData.trash_bin_location,
      gate_code: formData.gate_code,
      garage_code: formData.garage_code,
      wastewater_system: formData.wastewater_system,
      septic_last_pumped: formData.septic_last_pumped,
      septic_company: formData.septic_company,
      utilities: formData.utilities,
      primary_cleaner: formData.primary_cleaner,
      backup_cleaner: formData.backup_cleaner,
      cleaner_satisfaction: formData.cleaner_satisfaction,
      cleaner_payment: formData.cleaner_payment,
      cleaner_quality: formData.cleaner_quality,
      supply_closet_location: formData.supply_closet_location,
      laundry_notes: formData.laundry_notes,
      guest_avatar: formData.guest_avatar,
      unique_selling_points: formData.unique_selling_points,
      existing_photos_link: formData.existing_photos_link,
      airbnb_link: formData.airbnb_link,
      vrbo_link: formData.vrbo_link,
      other_listing_links: formData.other_listing_links,
      pets_allowed: formData.pets_allowed,
      pet_deposit: formData.pet_deposit,
      pet_size_restrictions: formData.pet_size_restrictions,
      pool_hot_tub_info: formData.pool_hot_tub_info,
      has_thermostat: formData.has_thermostat,
      thermostat_login: formData.thermostat_login,
      house_quirks: formData.house_quirks,
      sensitive_neighbor_notes: formData.sensitive_neighbor_notes,
      ...
      known_maintenance_issues: formData.known_maintenance_issues,
      lawncare_provider: formData.lawncare_provider,
      pest_control_provider: formData.pest_control_provider,
      hvac_service: formData.hvac_service,
      maintenance_contact: formData.maintenance_contact,
      emergency_contact_24_7: formData.emergency_contact_24_7,
      insurance_corporate_contacts: formData.insurance_corporate_contacts,
      has_security_system: formData.has_security_system,
      security_brand: formData.security_brand,
      alarm_code: formData.alarm_code,
      has_cameras: formData.has_cameras,
      camera_locations: formData.camera_locations,
      camera_login_website: formData.camera_login_website,
      camera_login_credentials: formData.camera_login_credentials,
      fire_extinguisher_locations: formData.fire_extinguisher_locations,
      smoke_co_detector_status: formData.smoke_co_detector_status,
      water_shutoff_location: formData.water_shutoff_location,
      breaker_panel_location: formData.breaker_panel_location,
      gas_shutoff_location: formData.gas_shutoff_location,
      government_id_url: formData.government_id_url,
      property_deed_url: formData.property_deed_url,
      property_tax_statement_url: formData.property_tax_statement_url,
      mortgage_statement_url: formData.mortgage_statement_url,
      entity_ownership: formData.entity_ownership,
      entity_documents_url: formData.entity_documents_url,
      has_hoa: formData.has_hoa,
      hoa_contact_name: formData.hoa_contact_name,
      hoa_contact_phone: formData.hoa_contact_phone,
      hoa_rules_url: formData.hoa_rules_url,
      str_permit_status: formData.str_permit_status,
      permit_number: formData.permit_number,
      insurance_provider: formData.insurance_provider,
      insurance_policy_number: formData.insurance_policy_number,
      guide_book_url: formData.guide_book_url,
      house_manual_url: formData.house_manual_url,
      parking_map_url: formData.parking_map_url,
      last_year_revenue: formData.last_year_revenue,
      airbnb_revenue_export_url: formData.airbnb_revenue_export_url,
      vrbo_revenue_export_url: formData.vrbo_revenue_export_url,
      ownerrez_revenue_export_url: formData.ownerrez_revenue_export_url,
      ...
      average_monthly_revenue: formData.average_monthly_revenue,
      peak_season: formData.peak_season,
      peak_season_adr: formData.peak_season_adr,
      revenue_statement_url: formData.revenue_statement_url,
      expense_report_url: formData.expense_report_url,
