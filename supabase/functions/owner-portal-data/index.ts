...
function getDemoPortalData() {
  ...
  return {
    ...
    expenses: [
      { id: "exp-demo-1", date: formatDate(new Date(today.getTime() - 5 * 24 * 60 * 60 * 1000)), amount: 125.99, purpose: "Pool maintenance supplies", vendor: "Leslie's Pool Supplies", category: "Maintenance", file_path: null, original_receipt_path: null, email_screenshot_path: "demo-receipts/pool-supplies.jpg" },
      { id: "exp-demo-2", date: formatDate(new Date(today.getTime() - 12 * 24 * 60 * 60 * 1000)), amount: 225.00, purpose: "Deep cleaning between guests", vendor: "CleanCo Pro", category: "Cleaning", file_path: null, original_receipt_path: null, email_screenshot_path: "demo-receipts/cleaning.jpg" },
      { id: "exp-demo-3", date: formatDate(new Date(today.getTime() - 18 * 24 * 60 * 60 * 1000)), amount: 89.00, purpose: "Welcome basket supplies", vendor: "Costco", category: "Guest Amenities", file_path: null, original_receipt_path: null, email_screenshot_path: "demo-receipts/costco.jpg" },
      { id: "exp-demo-4", date: formatDate(new Date(today.getTime() - 25 * 24 * 60 * 60 * 1000)), amount: 45.00, purpose: "HVAC filter replacement", vendor: "Home Depot", category: "Maintenance", file_path: null, original_receipt_path: null, email_screenshot_path: "demo-receipts/hvac.jpg" },
    ],
    credentials: [
