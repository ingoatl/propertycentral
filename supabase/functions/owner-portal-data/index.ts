...
// OPTIMISTIC numbers: $10k+ monthly revenue, hybrid property
function getDemoPortalData() {
  ...
  return {
    ...
    property: {
      ...
      rental_type: "hybrid", // Hybrid property - STR + MTR
      image_path: null, // Will use bundled demo image
      management_fee_percentage: 18,
      bedrooms: 5,
      bathrooms: 4,
      square_feet: 3200,
      max_guests: 12,
    ...
    statements: [
      {
        ...
        total_expenses: 485,
        net_to_owner: 9875,
        actual_net_earnings: 9875,
        status: "sent",
        short_term_revenue: 6350,
        mid_term_revenue: 6500,
      },
      {
        id: "stmt-demo-2",
        ...
        total_expenses: 390,
        net_to_owner: 8654,
        actual_net_earnings: 8654,
        status: "completed",
        short_term_revenue: 4700,
        mid_term_revenue: 6500,
      },
      {
        id: "stmt-demo-3",
        ...
        total_expenses: 520,
        net_to_owner: 10302,
        actual_net_earnings: 10302,
        status: "completed",
        short_term_revenue: 6900,
        mid_term_revenue: 6500,
      },
      {
        id: "stmt-demo-4",
        reconciliation_month: formatMonth(fourMonthsAgo),
        total_revenue: 10950,
        total_expenses: 345,
        net_to_owner: 8451,
        actual_net_earnings: 8451,
        status: "completed",
        short_term_revenue: 4450,
        mid_term_revenue: 6500,
      },
      {
        id: "stmt-demo-5",
        reconciliation_month: formatMonth(fiveMonthsAgo),
        total_revenue: 14200,
        total_expenses: 610,
        net_to_owner: 10864,
        actual_net_earnings: 10864,
        status: "completed",
        short_term_revenue: 7700,
        mid_term_revenue: 6500,
      },
      {
        id: "stmt-demo-6",
        reconciliation_month: formatMonth(sixMonthsAgo),
        total_revenue: 11750,
        total_expenses: 425,
        net_to_owner: 9047,
        actual_net_earnings: 9047,
        status: "completed",
        short_term_revenue: 5250,
        mid_term_revenue: 6500,
      },
    ],
    expenses: [
      // Use real Berkley receipts from storage (property ID: bdb82ccb-b2fa-42fb-8c58-42aad6e2ef38)
      { id: "exp-demo-1", date: formatDate(new Date(today.getTime() - 5 * 24 * 60 * 60 * 1000)), amount: 56.28, purpose: "Guest amenity supplies", vendor: "Amazon", category: "order", file_path: null, original_receipt_path: null, email_screenshot_path: "bdb82ccb-b2fa-42fb-8c58-42aad6e2ef38/expense-receipt-1764482458489-rvl04.html" },
      { id: "exp-demo-2", date: formatDate(new Date(today.getTime() - 12 * 24 * 60 * 60 * 1000)), amount: 20.89, purpose: "Bathroom supplies restock", vendor: "Amazon", category: "order", file_path: null, original_receipt_path: null, email_screenshot_path: "bdb82ccb-b2fa-42fb-8c58-42aad6e2ef38/expense-receipt-1764396068471-al9zc.html" },
      { id: "exp-demo-3", date: formatDate(new Date(today.getTime() - 18 * 24 * 60 * 60 * 1000)), amount: 10.59, purpose: "Kitchen cleaning supplies", vendor: "Amazon", category: "order", file_path: null, original_receipt_path: null, email_screenshot_path: "bdb82ccb-b2fa-42fb-8c58-42aad6e2ef38/expense-receipt-1764223290878-jn3b19.html" },
      { id: "exp-demo-4", date: formatDate(new Date(today.getTime() - 25 * 24 * 60 * 60 * 1000)), amount: 10.38, purpose: "Laundry supplies", vendor: "Amazon", category: "order", file_path: null, original_receipt_path: null, email_screenshot_path: "bdb82ccb-b2fa-42fb-8c58-42aad6e2ef38/expense-receipt-1762581667824-7slzxf.html" },
      // Additional demo expenses with receipt variety
      { id: "exp-demo-5", date: formatDate(new Date(today.getTime() - 35 * 24 * 60 * 60 * 1000)), amount: 125.99, purpose: "Pool maintenance supplies", vendor: "Leslie's Pool Supplies", category: "Maintenance", file_path: null, original_receipt_path: null, email_screenshot_path: "bdb82ccb-b2fa-42fb-8c58-42aad6e2ef38/expense-receipt-1764482458489-rvl04.html" },
      { id: "exp-demo-6", date: formatDate(new Date(today.getTime() - 45 * 24 * 60 * 60 * 1000)), amount: 225.00, purpose: "Deep cleaning between guests", vendor: "CleanCo Pro", category: "Cleaning", file_path: null, original_receipt_path: null, email_screenshot_path: "bdb82ccb-b2fa-42fb-8c58-42aad6e2ef38/expense-receipt-1764396068471-al9zc.html" },
      { id: "exp-demo-7", date: formatDate(new Date(today.getTime() - 55 * 24 * 60 * 60 * 1000)), amount: 89.00, purpose: "Welcome basket supplies", vendor: "Costco", category: "Guest Amenities", file_path: null, original_receipt_path: null, email_screenshot_path: "bdb82ccb-b2fa-42fb-8c58-42aad6e2ef38/expense-receipt-1764223290878-jn3b19.html" },
      { id: "exp-demo-8", date: formatDate(new Date(today.getTime() - 65 * 24 * 60 * 60 * 1000)), amount: 45.00, purpose: "HVAC filter replacement", vendor: "Home Depot", category: "Maintenance", file_path: null, original_receipt_path: null, email_screenshot_path: "bdb82ccb-b2fa-42fb-8c58-42aad6e2ef38/expense-receipt-1762581667824-7slzxf.html" },
    ],
    credentials: [
      ...
      { id: "cred-4", service_name: "Ring Doorbell", username: "ritaway@peachhausgroup.com", password: "Contact PeachHaus", url: "https://ring.com", notes: "Motion alerts enabled" },
    ],
    bookings: {
      str: [
        { id: "str-1", booking_id: "ORZ-12345", guest_name: "Jennifer Martinez", check_in: formatDate(new Date(today.getTime() + 3 * 24 * 60 * 60 * 1000)), check_out: formatDate(new Date(today.getTime() + 8 * 24 * 60 * 60 * 1000)), total_amount: 1875, management_fee: 337, booking_status: "confirmed" },
        { id: "str-2", booking_id: "ORZ-12346", guest_name: "The Williams Family", check_in: formatDate(new Date(today.getTime() + 15 * 24 * 60 * 60 * 1000)), check_out: formatDate(new Date(today.getTime() + 22 * 24 * 60 * 60 * 1000)), total_amount: 2625, management_fee: 472, booking_status: "confirmed" },
        { id: "str-3", booking_id: "ORZ-12344", guest_name: "David Chen", check_in: formatDate(new Date(today.getTime() - 10 * 24 * 60 * 60 * 1000)), check_out: formatDate(new Date(today.getTime() - 4 * 24 * 60 * 60 * 1000)), total_amount: 2250, management_fee: 405, booking_status: "completed" },
        { id: "str-4", booking_id: "ORZ-12343", guest_name: "Sarah Williams", check_in: formatDate(new Date(today.getTime() - 25 * 24 * 60 * 60 * 1000)), check_out: formatDate(new Date(today.getTime() - 20 * 24 * 60 * 60 * 1000)), total_amount: 1875, management_fee: 337, booking_status: "completed" },
        { id: "str-5", booking_id: "ORZ-12342", guest_name: "Michael Johnson", check_in: formatDate(new Date(today.getTime() - 40 * 24 * 60 * 60 * 1000)), check_out: formatDate(new Date(today.getTime() - 35 * 24 * 60 * 60 * 1000)), total_amount: 1500, management_fee: 270, booking_status: "completed" },
      ],
      mtr: [
        { id: "mtr-1", tenant_name: "Robert Anderson", tenant_email: "r.anderson@delta.com", start_date: formatDate(new Date(today.getTime() - 60 * 24 * 60 * 60 * 1000)), end_date: formatDate(new Date(today.getTime() + 30 * 24 * 60 * 60 * 1000)), monthly_rent: 6500, deposit_amount: 6500, status: "active", notes: "Delta executive relocation - excellent tenant, extended stay" },
        { id: "mtr-2", tenant_name: "Dr. Amanda Foster", tenant_email: "a.foster@emory.edu", start_date: formatDate(new Date(today.getTime() + 45 * 24 * 60 * 60 * 1000)), end_date: formatDate(new Date(today.getTime() + 135 * 24 * 60 * 60 * 1000)), monthly_rent: 6500, deposit_amount: 6500, status: "confirmed", notes: "Emory medical rotation - 3 month contract" },
      ],
    },
    reviews: [
      { id: "rev-1", guestName: "Jennifer M.", rating: 5, text: "Absolutely stunning property! The pool was pristine and the host communication was exceptional. The game room was a hit with our kids. Will definitely return!", date: formatDate(new Date(today.getTime() - 8 * 24 * 60 * 60 * 1000)), source: "Airbnb" },
      { id: "rev-2", guestName: "David C.", rating: 5, text: "Perfect for our family reunion. Clean, spacious, and every amenity we needed. The smart home features were a nice touch. PeachHaus really knows how to manage properties!", date: formatDate(new Date(today.getTime() - 15 * 24 * 60 * 60 * 1000)), source: "VRBO" },
      { id: "rev-3", guestName: "Sarah W.", rating: 5, text: "Best Airbnb experience we've ever had! The property exceeded our expectations. Great location near the Battery Atlanta and so many restaurants.", date: formatDate(new Date(today.getTime() - 22 * 24 * 60 * 60 * 1000)), source: "Airbnb" },
      { id: "rev-4", guestName: "Michael J.", rating: 5, text: "We hosted a small corporate retreat here and it was perfect. The home gym and quiet workspace made it ideal for our team.", date: formatDate(new Date(today.getTime() - 35 * 24 * 60 * 60 * 1000)), source: "Booking.com" },
      { id: "rev-5", guestName: "Emily R.", rating: 4, text: "Beautiful home with amazing amenities. Only minor thing was the hot tub took a bit to heat up. Otherwise flawless stay!", date: formatDate(new Date(today.getTime() - 50 * 24 * 60 * 60 * 1000)), source: "Airbnb" },
    ],
    performance: {
      totalRevenue: 74350,
      strRevenue: 35350,
    ...
    monthlyRevenue: [
      { month: formatMonth(sixMonthsAgo).substring(0, 7), str: 5250, mtr: 6500, total: 11750 },
      { month: formatMonth(fiveMonthsAgo).substring(0, 7), str: 7700, mtr: 6500, total: 14200 },
      { month: formatMonth(fourMonthsAgo).substring(0, 7), str: 4450, mtr: 6500, total: 10950 },
      { month: formatMonth(threeMonthsAgo).substring(0, 7), str: 6900, mtr: 6500, total: 13400 },
      { month: formatMonth(twoMonthsAgo).substring(0, 7), str: 4700, mtr: 6500, total: 11200 },
      { month: formatMonth(lastMonth).substring(0, 7), str: 6350, mtr: 6500, total: 12850 },
    ],
    ownerHighlights: [
      { type: "review", message: "New 5-star review from Jennifer M.! Your property now has 47 reviews with 4.9 avg rating.", date: formatDate(new Date(today.getTime() - 8 * 24 * 60 * 60 * 1000)) },
      { type: "booking", message: "High-value STR booking confirmed: The Williams Family (7 nights, $2,625)", date: formatDate(today) },
      { type: "revenue", message: "MTR tenant Dr. Amanda Foster confirmed 3-month contract at $6,500/mo starting next month!", date: formatDate(new Date(today.getTime() - 3 * 24 * 60 * 60 * 1000)) },
      { type: "milestone", message: "Congratulations! Your property hit $74,000+ YTD revenue - on track for $120k+ this year!", date: formatDate(new Date(today.getTime() - 1 * 24 * 60 * 60 * 1000)) },
    ],
    revenueBreakdown: {
      mtr: [],
      str: [],
      summary: {
        mtrFromStatements: 39000,
        mtrFromFutureBookings: 13000,
        strFromReconciliation: 35350,
        strFromBookings: 35350,
      }
    },
    dataWarnings: [],
  };
