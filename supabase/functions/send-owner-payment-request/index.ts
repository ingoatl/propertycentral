...
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; margin: 0; padding: 0; background-color: #f8f9fa;">
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background: white; border-radius: 16px; padding: 40px; margin-top: 20px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
      ...
      <p style="color: #4a5568; line-height: 1.6; margin-bottom: 20px;">
        To streamline billing for <strong>${propertyList}</strong>, we need to set up your payment method for recurring management fees and property expenses.
      </p>
      ...
      <div style="background: #f7fafc; border-radius: 8px; padding: 16px; margin-bottom: 20px;">
        ...
        <ul style="color: #4a5568; margin: 0; padding: 0 0 0 20px; font-size: 14px; line-height: 1.8;">
          <li><strong>Bank Account (ACH):</strong> 1% processing fee - Recommended</li>
      ...
      <p style="color: #a0aec0; font-size: 12px; text-align: center;">
        This link will expire in 24 hours. If you have any questions, reply to this email or contact us at info@peachhausgroup.com
      </p>
    </div>
