...
export const ONBOARDING_PHASES: PhaseDefinition[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { title: "Photo 1: Exterior Arrival Shot", field_type: "text", description: "Upload link for exterior arrival photo" },
      { title: "Photo 2: Main Living Area (Hero Room)", field_type: "text", description: "Upload link for main living area photo" },
      { title: "Photo 3: Signature / Selling Feature", field_type: "text", description: "Upload link for signature feature (game room, view, pool, deck, kitchen island, fireplace, etc.)" },
      { title: "Photo 4: Primary Bedroom (Master)", field_type: "text", description: "Upload link for primary bedroom photo" },
      { title: "Photo 5: Kitchen (Wide Angle)", field_type: "text", description: "Upload link for kitchen wide angle photo" },
