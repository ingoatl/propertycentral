...
import { Paintbrush, Home, Crown, AlertCircle } from "lucide-react";
      ...
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="text-center mb-10 lg:mb-12">
          ...
          <p className="text-white/60 text-xl lg:text-2xl">
            Budgets vary based on scope, timeline, and property size
          </p>
        </div>
        ...
        {/* Disclaimer */}
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-5 lg:p-6 border border-white/10 flex items-start gap-4">
          <AlertCircle className="w-6 h-6 text-amber-400 flex-shrink-0 mt-0.5" />
          <div>
            <p className="text-white/70 text-base lg:text-lg">
              <span className="text-white font-semibold">Note:</span> Budgets do not include painting, 
              structural renovations, wallpaper installation, or board and batten accents. 
              Those services are quoted separately based on scope.
            </p>
          </div>
        </div>
      </div>
