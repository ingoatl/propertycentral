...
export function StatementsSlide() {
  const features = [
    { icon: FileText, text: "Monthly statement history" },
    { icon: TrendingUp, text: "Gross vs Net earnings clearly shown" },
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a1a] via-[#1a1a2e] to-[#0a0a1a] flex flex-col items-center py-16 px-4 md:px-8">
      ...
      >
        <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">
          Financial <span className="text-[#fae052]">Statements</span>
        </h2>
        <p className="text-lg text-white/70">
          Transparent financials you can access and download anytime, from anywhere
        </p>
      </motion.div>
