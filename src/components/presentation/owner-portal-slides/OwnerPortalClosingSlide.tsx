...
export function OwnerPortalClosingSlide() {
  return (
    <div className="min-h-screen min-h-[100dvh] bg-gradient-to-br from-[#0a0a1a] via-[#1a1a2e] to-[#0a0a1a] flex flex-col items-center justify-center px-4 md:px-8 py-12 pb-28">
      ...
      >
        <div className="relative">
          <img
            ...
            className="w-28 h-28 md:w-40 md:h-40 rounded-full object-cover border-4 border-[#fae052]/30 shadow-2xl"
          />
      ...
      >
        <h2 className="text-2xl md:text-5xl lg:text-6xl font-bold text-white mb-3">
          Ready to Experience{" "}
      ...
      >
        <Button
          size="lg"
          className="bg-[#fae052] hover:bg-[#fae052]/90 text-black font-semibold px-6 py-5 text-base"
        ...
        <Button
          size="lg"
          className="bg-white hover:bg-white/90 text-black font-semibold px-6 py-5 text-base"
      ...
      >
        <p className="text-white/50 text-xs mb-2">Questions? Reach out directly</p>
        <div className="flex flex-wrap items-center justify-center gap-3">
          <a 
            href="tel:+14048005932" 
            className="flex items-center gap-1.5 text-[#fae052] hover:underline font-medium text-sm"
          >
