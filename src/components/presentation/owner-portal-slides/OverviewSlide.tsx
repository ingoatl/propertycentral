...
export function OverviewSlide({ isActive }: OverviewSlideProps) {
  ...
  return (
    <div className="min-h-screen min-h-[100dvh] bg-gradient-to-br from-[#0a0a1a] via-[#1a1a2e] to-[#0a0a1a] flex flex-col px-4 md:px-8 pt-16 pb-28">
      {/* Headline - Compact at top */}
      <motion.div 
        className="text-center mb-3 max-w-4xl mx-auto shrink-0"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
      >
        <h2 className="text-xl md:text-4xl lg:text-5xl font-bold text-white mb-1">
      ...
      <motion.div
        className="bg-gradient-to-r from-amber-900/30 to-orange-900/30 border border-amber-500/30 rounded-xl p-2 md:p-3 mb-3 max-w-md w-full mx-auto shrink-0"
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-white/60 text-[10px] md:text-xs truncate">Personalized audio recap demo</p>
          </div>
      ...
      {/* Screenshot - Takes most of the remaining space */}
      <motion.div
        className="relative w-full max-w-5xl mx-auto flex-1 min-h-0 flex items-start justify-center overflow-hidden rounded-xl"
      ...
      {/* Pain Point Solved - At bottom */}
      <motion.div
        className="mt-3 bg-emerald-500/10 border border-emerald-500/30 rounded-lg px-4 md:px-6 py-2 max-w-2xl text-center mx-auto shrink-0"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
