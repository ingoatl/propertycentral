...
export function CommunicationSlide() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a1a] via-[#1a1a2e] to-[#0a0a1a] flex flex-col items-center py-6 px-4 md:px-8">
      ...
      <motion.div
        className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-3xl mb-4"
      ...
      <motion.div
        className="bg-[#fae052]/10 border border-[#fae052]/30 rounded-xl px-6 py-3 max-w-2xl text-center"
      ...
      {/* Pain Point Solved - directly under content */}
      <motion.div
